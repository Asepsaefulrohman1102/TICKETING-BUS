        ...
        <div id="header-carousel" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="w-100" src="img/BUS-1.jpg" alt="Image">
                    <div class="carousel-caption">
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-7">
                                    <h1 class="display-2 text-light mb-5 animated slideInDown">Welcome To Ticket Bus</h1>
                                    <?php if (isset($_SESSION['pelanggan'])) : ?>
                                        <a href="pages-logout.php" class="btn btn-primary py-sm-3 px-sm-5">Logout</a>
                                    <?php else : ?>
                                        <a href="pages-login.php" class="btn btn-primary py-sm-3 px-sm-5">Login</a>
                                    <?php endif; ?>
                ...
                <div class="carousel-item">
                    <img class="w-100" src="img/BUS-2.jpg" alt="Image">
                    <div class="carousel-caption">
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-7">
                                    <h1 class="display-2 text-light mb-5 animated slideInDown">Pesanan Anda Prioritas Kami</h1>
                                    <?php if (isset($_SESSION['pelanggan'])) : ?>
                                        <a href="pages-logout.php" class="btn btn-primary py-sm-3 px-sm-5">Logout</a>
                                    <?php else : ?>
                                        <a href="pages-login.php" class="btn btn-primary py-sm-3 px-sm-5">Login</a>
                ...
                <div class="col-lg-4 wow fadeIn" data-wow-delay="0.1s">
                    <div class="bg-white shadow d-flex align-items-center h-100 p-4" style="min-height: 150px;">
                        <div class="d-flex">
                            ...
                            <div class="ps-4">
                                <h5> Mudah </h5>
                                <span>Anda Dapat Memesan Tiket Dimana Saja</span>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 wow fadeIn" data-wow-delay="0.3s">
                    <div class="bg-white shadow d-flex align-items-center h-100 p-4" style="min-height: 150px;">
                        <div class="d-flex">
                            ...
                            <div class="ps-4">
                                <h5>Banyak Fasilitas</h5>
                                <span>Kami Menyediakan Berbagai Fasilitas Yang Anda Butuhkan</span>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 wow fadeIn" data-wow-delay="0.5s">
                    <div class="bg-white shadow d-flex align-items-center h-100 p-4" style="min-height: 150px;">
                        <div class="d-flex">
                            ...
                            <div class="ps-4">
                                <h5>Aman</h5>
                                <span>Segala Macam Transaksi Anda Kami Pastikan Aman</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row g-5">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="position-relative overflow-hidden ps-5 pt-5 h-100" style="min-height: 400px;">
                        <img class="position-absolute w-100 h-100" src="img/BUS-1.jpg" alt="" style="object-fit: cover;">
                        <img class="position-absolute top-0 start-0 bg-white pe-3 pb-3" src="img/bus-solid.jpg" alt="" style="width: 200px; height: 200px; border-radius: 15%;">
                    </div>
                </div>
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="h-100">
                        <h6 class="text-primary text-uppercase mb-2">Tentang Kami</h6>
                        <h1 class="display-6 mb-4">Kami Membantu Anda Dalam Melakukan Perjalanan</h1>
                        <p>Ticket Bus Adalah Salah Satu Situs Website Pemesanan Tiket Online Khususnya Tiket Bus.</p>
                        <p class="mb-4">Dalam Website Ticket Bus Menyediakan Fasilitas Yang Fleksibel, Anda Dapat Memilih Tempat Duduk Sesuai Keinginan Anda.</p>
                        <div class="row g-2 mb-4 pb-2">
                            <div class="col-sm-6">
                                <i class="fa fa-check text-primary me-2"></i>Aman
                            </div>
                            <div class="col-sm-6">
                                <i class="fa fa-check text-primary me-2"></i>Terpecaya
                            </div>
                            <div class="col-sm-6">
                                <i class="fa fa-check text-primary me-2"></i>Dapat Digunakan Dimana Saja
                            </div>
                            <div class="col-sm-6">
                                <i class="fa fa-check text-primary me-2"></i>Terjangkau
                            </div>
                        </div>
                        <!-- <div class="row g-4">
                            <div class="col-sm-6">
